...
static const char col_sel_br[]       = "#5b73a3";
static const char col_norm_br[]      = "#2e3440";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_norm_br },
	[SchemeSel]  = { col_gray4, col_cyan,  col_sel_br  },
};
